...
user = User.find_by(username: 'worldtraveler')
user.update(id: '1')
album1 = Album.find_by(title: 'Philadelphia - The Journey Begins!')
album1.update(id: '1')
album2 = Album.find_by(title: 'The Great Plains - Heading Into Danger')
album2.update(id: '2')
album3 = Album.find_by(title: "Dakota - Racing Against Winter's Approach")
album3.update(id: '3')
album4 = Album.find_by(title: 'Rockies - Rockies in Sight')
album4.update(id: '4')
